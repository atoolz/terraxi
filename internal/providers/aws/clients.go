...
// EC2API declares the EC2 methods Terraxi uses for discovery.
...
// S3API declares the S3 methods Terraxi uses for discovery.
...
// IAMAPI declares the IAM methods Terraxi uses for discovery.
...
// RDSAPI declares the RDS methods Terraxi uses for discovery.
...
// ELBAPI declares the ELBv2 methods Terraxi uses for discovery.
...
// Route53API declares the Route53 methods Terraxi uses for discovery.
type Route53API interface {
	ListHostedZones(ctx context.Context, params *route53.ListHostedZonesInput, optFns ...func(*route53.Options)) (*route53.ListHostedZonesOutput, error)
	ListResourceRecordSets(ctx context.Context, params *route53.ListResourceRecordSetsInput, optFns ...func(*route53.Options)) (*route53.ListResourceRecordSetsOutput, error)
}

// LambdaAPI declares the Lambda methods Terraxi uses for discovery.
...
// ECSAPI declares the ECS methods Terraxi uses for discovery.
...
// CloudWatchAPI declares the CloudWatch methods Terraxi uses for discovery.
...
// CloudWatchLogsAPI declares the CloudWatch Logs methods Terraxi uses for discovery.
